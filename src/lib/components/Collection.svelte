...
>
    <a href="/collection/{collection.slug}">
        <div class="group relative block">
            ...
            <div class="absolute inset-0 bg-black/25 transition-all duration-500 group-hover:bg-black/40"></div>
            ...
            <div class="absolute inset-0 flex flex-col items-start justify-end p-6">
                ...
                <span
                    class="mt-3 inline-block bg-gradient-to-r from-lime-800 to-lime-700 px-5 py-3 text-xs font-medium uppercase tracking-wide text-white hover:bg-lime-700 rounded-lg transition-colors duration-300"
                >
                    {m.shop_collection()} →
                </span>
            </div>
