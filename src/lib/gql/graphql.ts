...
export type SearchResultFragment = { __typename?: 'SearchResult', productName: string, slug: string, description: string, productId: string, facetIds: Array<string>, facetValueIds: Array<string>, currencyCode: CurrencyCode, productAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, price: { __typename?: 'PriceRange', min: number, max: number } | { __typename?: 'SinglePrice', value: number } } & { ' $fragmentName'?: 'SearchResultFragment' };
