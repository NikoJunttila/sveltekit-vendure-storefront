...
export type ActiveChannelQuery = {
	...
	activeChannel: {
		...
		availableCurrencyCodes: Array<CurrencyCode>;
		defaultCurrencyCode: CurrencyCode;
		seller?: { __typename?: 'Seller'; name: string } | null;
	};
};
...
export type CollectionFragment = {
	...
	slug: string;
	description: string;
	parent?: { __typename?: 'Collection'; id: string; name: string; slug: string } | null;
	breadcrumbs: Array<{
		__typename?: 'CollectionBreadcrumb';
		id: string;
		name: string;
...
export type GetTopLevelCollectionsQuery = {
	__typename?: 'Query';
	collections: {
		__typename?: 'CollectionList';
		totalItems: number;
...
export type CustomerFragment = {
	...
	addresses?: Array<
		{ __typename?: 'Address' } & { ' $fragmentRefs'?: { AddressFragment: AddressFragment } }
	> | null;
	orders: {
		__typename?: 'OrderList';
		totalItems: number;
...
export type GetCustomerQuery = {
	__typename?: 'Query';
	activeCustomer?:
		| ({ __typename?: 'Customer' } & { ' $fragmentRefs'?: { CustomerFragment: CustomerFragment } })
		| null;
};
...
export type PaytrailPaymentMutation = {
	__typename?: 'Mutation';
	createPaytrailPaymentIntent: { __typename?: 'PaytrailPaymentIntent'; href: string };
};

export type PaytrailMultiPaymentMutationVariables = Exact<{ [key: string]: never }>;

export type PaytrailMultiPaymentMutation = {
	__typename?: 'Mutation';
	createMultiPTintent: { __typename?: 'PaytrailPaymentIntent'; href: string };
};
	...
	lines: Array<{
		...
		productVariant: {
			...
			options: Array<{
				...
				code: string;
				name: string;
				group: { __typename?: 'ProductOptionGroup'; code: string; name: string };
			}>;
		};
		featuredAsset?: { __typename?: 'Asset'; id: string; preview: string } | null;
	}>;
...
export type ActiveOrderFragment = {
	...
	lines: Array<{
		...
		productVariant: {
			...
			name: string;
			sku: string;
			product: { __typename?: 'Product'; slug: string; name: string };
			options: Array<{
				__typename?: 'ProductOption';
				code: string;
				name: string;
	...
	discounts: Array<{ __typename?: 'Discount'; description: string; amountWithTax: number }>;
	promotions: Array<{
		__typename?: 'Promotion';
		id: string;
		startsAt?: any | null;
...
export type ShippingMethodQuoteFragment = {
	__typename?: 'ShippingMethodQuote';
	id: string;
	price: number;
	priceWithTax: number;
	...
	description: string;
	metadata?: any | null;
} & { ' $fragmentName'?: 'ShippingMethodQuoteFragment' };
...
export type GetOrderShippingMethodsQuery = {
	__typename?: 'Query';
...
export type GetOrderPaymentMethodsQuery = {
	__typename?: 'Query';
...
export type AddOrderPaymentMutation = {
	__typename?: 'Mutation';
	addPaymentToOrder:
...
export type ProductFragment = {
	...
	description: string;
	featuredAsset?: { __typename?: 'Asset'; id: string; preview: string } | null;
	variants: Array<{ __typename?: 'ProductVariant'; id: string; price: number; stockLevel: string }>;
...
export type ProductDetailFragment = {
	...
	description: string;
	featuredAsset?:
		| ({ __typename?: 'Asset' } & { ' $fragmentRefs'?: { AssetFragment: AssetFragment } })
		| null;
	assets: Array<{ __typename?: 'Asset' } & { ' $fragmentRefs'?: { AssetFragment: AssetFragment } }>;
	optionGroups: Array<{
		__typename?: 'ProductOptionGroup';
		id: string;
		code: string;
	...
	collections: Array<{
		__typename?: 'Collection';
		breadcrumbs: Array<{ __typename?: 'CollectionBreadcrumb'; name: string; slug: string }>;
	}>;
...
export type AssetFragment = {
	...
	tags: Array<{ __typename?: 'Tag'; id: string; value: string; createdAt: any; updatedAt: any }>;
...
export type FacetValueResultFragment = {
	__typename?: 'FacetValueResult';
	count: number;
	facetValue: {
		__typename?: 'FacetValue';
...
} & { ' $fragmentName'?: 'FacetValueResultFragment' };
...
} as unknown as DocumentNode<ActiveOrderFragment, unknown>;
export const ShippingMethodQuoteFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'ShippingMethodQuote' },
...
} as unknown as DocumentNode<ShippingMethodQuoteFragment, unknown>;
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					...
					{ kind: 'Field', name: { kind: 'Name', value: 'facetIds' } },
...
export const FacetValueResultFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'FacetValueResult' },
...
} as unknown as DocumentNode<FacetValueResultFragment, unknown>;
...
export const GetTopLevelCollectionsDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
...
} as unknown as DocumentNode<GetTopLevelCollectionsQuery, GetTopLevelCollectionsQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'Order' } }
													]
												}
											},
											{ kind: 'Field', name: { kind: 'Name', value: 'totalItems' } }
...
export const PaytrailPaymentDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'paytrailPayment' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'createPaytrailPaymentIntent' },
						selectionSet: {
							kind: 'SelectionSet',
...
} as unknown as DocumentNode<PaytrailPaymentMutation, PaytrailPaymentMutationVariables>;
export const PaytrailMultiPaymentDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'paytrailMultiPayment' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
...
} as unknown as DocumentNode<PaytrailMultiPaymentMutation, PaytrailMultiPaymentMutationVariables>;
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'createStripePaymentIntent' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [{ kind: 'Field', name: { kind: 'Name', value: 'createStripePaymentIntent' } }]
			}
		}
	]
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'ActiveOrder' } }]
						}
					}
				]
			}
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								{ kind: 'Field', name: { kind: 'Name', value: '__typename' } },
								{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'ActiveOrder' } },
								{
									kind: 'InlineFragment',
									typeCondition: {
										kind: 'NamedType',
...
export const AddOrderCouponCodeDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'AddOrderCouponCode' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
...
} as unknown as DocumentNode<AddOrderCouponCodeMutation, AddOrderCouponCodeMutationVariables>;
export const RemoveOrderCouponCodeDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'RemoveOrderCouponCode' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'couponCode' } },
...
} as unknown as DocumentNode<RemoveOrderCouponCodeMutation, RemoveOrderCouponCodeMutationVariables>;
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'GetOrderShippingMethods' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'ShippingMethodQuote' } }
							]
						}
					}
				]
...
} as unknown as DocumentNode<GetOrderShippingMethodsQuery, GetOrderShippingMethodsQueryVariables>;
...
>;
export const GetOrderPaymentMethodsDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'GetOrderPaymentMethods' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
...
} as unknown as DocumentNode<GetOrderPaymentMethodsQuery, GetOrderPaymentMethodsQueryVariables>;
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'AddOrderPayment' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
...
} as unknown as DocumentNode<AddOrderPaymentMutation, AddOrderPaymentMutationVariables>;
							...
							selections: [
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'ProductDetail' } }
										]
									}
								},
								{ kind: 'Field', name: { kind: 'Name', value: 'totalItems' } }
							...
							selections: [
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'totalItems' } },
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'FacetValueResult' } }
										]
									}
								}
							]
