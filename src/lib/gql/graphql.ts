...
export type CollectionFragment = { __typename?: 'Collection', id: string, name: string, slug: string, description: string, parent?: { __typename?: 'Collection', id: string, name: string, slug: string } | null, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null } & { ' $fragmentName'?: 'CollectionFragment' };
