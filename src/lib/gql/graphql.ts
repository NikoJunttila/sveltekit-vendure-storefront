...
export type ProductDetailCustomFieldsFragment = { __typename?: 'Product', id: string, name: string, slug: string, description: string, featuredAsset?: (
    ...
    & { ' $fragmentRefs'?: { 'AssetFragment': AssetFragment } }
      ...
      { __typename?: 'Asset' }
      & { ' $fragmentRefs'?: { 'AssetFragment': AssetFragment } }
    )> }>, collections: Array<{ __typename?: 'Collection', breadcrumbs: Array<{ __typename?: 'CollectionBreadcrumb', name: string, slug: string }> }> } & { ' $fragmentName'?: 'ProductDetailCustomFieldsFragment' };
